        ...
        <div class="mv-card">
          ...
          <div class="mv-section">
            <div class="defecto-container">
              ...
              <label class="checkbox-card" for="check-lente">
        ...
        <div class="mv-card">
          ...
          <div class="mv-section">
            ...
            <textarea
              ...
              name="descripcion"
              placeholder="Describe el estado final del equipo y las acciones realizadas durante el mantenimiento."
              required
            ></textarea>
          </div>
