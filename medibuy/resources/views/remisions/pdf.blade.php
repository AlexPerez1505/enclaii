...
<table class="table">
  <thead>
    <tr>
      ...
      <th>Descripción</th>
      <th style="width:70px;">Importe Unitario</th>
  ...
  <div style="margin-bottom:1rem;">
    ...
    <div class="note-box">
      <ul style="margin:0; padding-left:18px;">
        ...
        <li>Si el equipo presenta fallas ajenas al servicio solicitado (daños previos o fallas ocultas), se informará al cliente y se generara una cotización adicional.</li>
  ...
  <div style="margin-bottom: 1.2rem;">
    ...
    @if(($remision->aplicar_iva ?? false))
      <table style="width: 100%; font-size: 13px;">
        ...
        <tr><td><strong>No. Tarjeta:</strong></td><td>4152 3145 7282 6959</td></tr>
        <tr>
