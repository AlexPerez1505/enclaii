...
<div id="previewProductImageWrap" style="display:none">
    <div style="padding:6px;font-size:12px;font-weight:bold;background:#f3f4f6; display:flex; justify-content:space-between; align-items:center;">
        <span>Imagen del producto</span>
        <button type="button" id="btnRemoveProductImg" title="Quitar imagen de producto"
            style="border:0; background:transparent; color:#ef4444; font-weight:700; cursor:pointer; font-size:14px; line-height:1; padding:0 4px;">
            ×
        </button>
    </div>
...
const btnRemoveProductImg = document.getElementById('btnRemoveProductImg');
...
Precio: $${precio}`;
    ...
    previewProductImageWrap.style.display = 'none';
}

});

/* Quitar imagen del producto sin afectar la imagen subida manualmente
   NI el resto de los datos del producto ya seleccionado
   (producto_id, keywords, mensaje, etc.) */
btnRemoveProductImg.addEventListener('click', (e) => {
  ...
  // Eso reseteaba el producto seleccionado. Se elimina para
  // conservar producto_id, keywords y el mensaje generado.
});
})();
