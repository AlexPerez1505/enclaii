...
.hero-panel::before{
    ...
    height:220px;
    border-radius:50%;
    background:rgba(166,214,242,.18);
    pointer-events:none;
}
...
.hero-panel::after{
    ...
    height:160px;
    border-radius:50%;
    background:rgba(166,214,242,.12);
}
...
/* Contenedor alineado para los botones de navegación y el título */
.hero-header-nav{
    display: flex;
    align-items: center;
    gap: 12px;
...
/* Estilos de botones circulares con iconos */
.btn-nav-icon{
    display: inline-flex;
    align-items: center;
...
.hero-search input:focus{
    border-color:#7cc8ef;
    box-shadow:0 0 0 5px rgba(124,200,239,.20);
}
  ...
  <div class="hero-panel">
    ...
    <div class="hero-top">
        ...
        <div class="hero-header-nav">
            {{-- Botón Regresar (Historial JS) --}}
            <button onclick="window.history.back();" class="btn-nav-icon" title="Regresar">
                <i class="bi bi-arrow-left-short" style="font-size: 24px;"></i>
            </button>
            ...
            <div class="hero-title">
                <h1>Solicitudes</h1>
                <p>Consulta el estado y seguimiento de materiales en tiempo real.</p>
            </div>
        </div>
        ...
        <div class="hero-stats">
            ...
            <div class="stat-card">
                <span>En Planta</span>
                <strong id="kPlant">0</strong>
            </div>

            <div class="stat-card">
                <span>Entregadas</span>
                <strong id="kEnt">0</strong>
            </div>

            <div class="stat-card">
                <span>Rechazadas</span>
                <strong id="kRech">0</strong>
            </div>
    ...
    <div class="hero-toolbar">
        ...
        <div class="hero-search">
            ...
            <input id="q"
                   type="text"
                   placeholder="Buscar material, categoría o estado...">

        </div>

        <div class="hero-filters" id="chips">

            <button class="chip is-active" data-v="todos">
                Todos
            </button>

            <button class="chip" data-v="Pendiente">
                Pendiente
            </button>

            <button class="chip" data-v="En Planta">
                En Planta
            </button>

            <button class="chip" data-v="Entregado">
                Entregado
            </button>

            <button class="chip" data-v="Rechazada">
                Rechazada
            </button>

        </div>

        <select id="ord" class="hero-select">
        ...
        <div class="hero-actions">
            ...
            <select id="ms" class="hero-select">
