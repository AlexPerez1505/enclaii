    ...
    @else
      ...
      @if(Auth::user()->hasRole('admin') || Auth::user()->hasRole('editor'))
        ...
        @endif
          ...
          {{-- ✅ NUEVO: acceso a Paquetes --}}
    @if(!in_array(route('paquetes.index'), $rutasRecientes))
    <a href="{{ route('paquetes.index') }}" class="menu-card"><i class="fas fa-box-open"></i><p>Paquetes</p></a>
    @endif
