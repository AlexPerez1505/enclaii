...
function RegistroUI(){
  return {
    /* ============================================================
       ESTADO INICIAL - TODAS LAS PROPIEDADES DEBEN ESTAR AQUÍ
       ============================================================ */
    ...
    get tiposKeys(){
      return Object.keys(this.tiposEquipos);
    },

    get subtiposArr(){
      return this.tipoSel ? this.tiposEquipos[this.tipoSel] : [];
    },
  ...
  "fibras de luz P": {
    ...
    "Fujinon": [
      ...
      radiologia: {
        ...
        'bateria': {}, 'chasis': {}, 'flat panel': {},
        'rayos x rodable': {}, 'rayos x portatil': {}
      },
...
'endoscopia veterinaria': {
    ...
    plantillasPorSubtipo: {
      ...
      'electrocauterios': [],
      "tubo de inserción": ["Tubo de inserción", "Compatibilidad", "Lote"],
      "tubo de guía de luz": ["Tubo guía de luz", "Compatibilidad", "Lote"],
      "camisa para líneas ensamblado": ["Camisa / coil pipe", "Compatibilidad", "Lote"],
      "canal de biopsia": ["Canal", "Resorte", "Lote"],
      "fibras de luz P": ["Fibra guía de luz", "Compatibilidad", "Lote"],
      "perillas de control u/d r/l": ["Perilla de control", "Eje / dirección", "Lote"],
      "conector eléctrico": ["Conector eléctrico", "Compatibilidad", "Lote"],
      "sección flexible ensamblada": ["Sección flexible", "Compatibilidad", "Lote"],
      "Pipeta Aire/Agua P": ["Boquilla / canal", "Compatibilidad", "Lote"],
      "adhesivos epóxico": ["Adhesivo", "Juego / presentación", "Lote"],
      "tornillería": ["Tornillo", "Medida", "Lote"],
      "rubber m": ["Rubber", "Medida", "Lote"],
      "rubber gm": ["Rubber", "Medida", "Lote"],
      "sección de flexión ensamblado m": ["Sección", "Compatibilidad", "Lote"],
      "líneas de angulación m": ["Línea", "Compatibilidad", "Lote"],
      "tubos de inserción m": ["Tubo", "Medida", "Lote"],
      "cable guía de luz m": ["Cable", "Medida", "Lote"],
      "stopper del cable de angulación m": ["Stopper", "Compatibilidad", "Lote"],
      "pipeta aire/agua m": ["Pipeta", "Compatibilidad", "Lote"],
      "body grip me": ["Body Grip", "Modelo", "Lote"],
      "camisa para lineas ensamblado me": ["Camisa", "Modelo", "Lote"],
      "canal de biopsia me": ["Canal", "Medida", "Lote"],
      "rubber me": ["Rubber", "Medida", "Lote"],
      "sección flexible ensamblada me": ["Sección", "Compatibilidad", "Lote"],
      "drums (poleas) me": ["Drums", "Modelo", "Lote"],
      "canal de aire/agua me": ["Canal", "Medida", "Lote"],
      "tarjeta electrica me": ["Tarjeta", "Modelo", "Lote"],
      "membrana flexible ccd oem me": ["Membrana", "Modelo", "Lote"],
      "tornillería me": ["Tornillo", "Medida", "Lote"],
      "tubos de inserción me": ["Tubo", "Medida", "Lote"],
      "tubo universal me": ["Tubo", "Medida", "Lote"],
      "stopper del cable de control me": ["Stopper", "Modelo", "Lote"],
      "poleas de control u/d r/l me": ["Perilla", "Modelo", "Lote"],
      "oring me": ["O-Ring", "Modelo", "Lote"],
      "canales de biopsia m": ["Canal", "Medida", "Lote"],
      "c-cover m": ["Cubierta", "Modelo", "Lote"],
      "fibras de luz m": ["Fibras", "Modelo", "Lote"],
      "fibras de luz me": ["Fibras", "Modelo", "Lote"]
    },
    ...
    init(){
      ...
      this.$nextTick(()=>{ 
        ...
        const tipoSelect = document.getElementById('eq_tipo');
        if (tipoSelect) {
