@php $anticipo = $anticipo ?? 0; @endphp
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<div style="margin-bottom: 2rem;">
    ...
    @if($venta->plan === 'contado')
        <ul style="font-size: 13px; line-height: 1.6;">
            <li>Este pago es unico y debe realizarse al momento de la entrega o en la fecha acordada.</li>
            ...
            <li>En caso de requerir factura, el monto sera mas IVA. Para su emision, sera necesario que nos proporcione sus datos fiscales completos</li>
        </ul>
    @else
        <ul style="font-size: 13px; line-height: 1.6;">
              @if($anticipo > 0)
            <li>El pago es con un anticipo de <strong>${{ number_format($anticipo, 2) }}</strong>.</li>
            @endif
...
<div style="margin-bottom: 1rem;">
    ...
    @if (empty($venta->iva) || $venta->iva == 0 || $venta->iva == 0.0)
        <table style="width: 100%; font-size: 13px; margin-bottom: 1rem;">
            ...
            <tr><td><strong>No. de Tarjeta:</strong></td><td>5579 0701 6980 4575</td></tr>
