...
<body>
  ...
  <div class="menu-grid" id="menuGrid">
    ...
    <a href="{{ url('/publicaciones') }}" class="menu-card"><i class="fas fa-newspaper"></i><p>Noticias</p></a>
    @endif
    ...
    @if(Auth::user()->hasRole('admin') || Auth::user()->hasRole('editor'))
      ...
      <a href="{{ url('/ventas') }}" class="menu-card"><i class="fas fa-receipt"></i><p>Remisiones</p></a>
      @endif
      @if(!in_array(url('/propuestas'), $rutasRecientes))
      <a href="{{ url('/propuestas') }}" class="menu-card"><i class="fas fa-file-contract"></i><p>Cotizaciones</p></a>
      @endif
      @if(!in_array(url('/remisions'), $rutasRecientes))
      <a href="{{ url('/remisions') }}" class="menu-card"><i class="fas fa-tools"></i><p>Mantenimiento</p></a>
      @endif
      @if(!in_array(url('/ventas/deudores'), $rutasRecientes))
      <a href="{{ url('/ventas/deudores') }}" class="menu-card"><i class="fas fa-hand-holding-usd"></i><p>Financiamientos</p></a>
      @endif
    ...
    @if(Auth::user()->hasRole('admin') || Auth::user()->hasRole('editor'))
      ...
      <a href="{{ url('/clientes') }}" class="menu-card"><i class="fas fa-address-book"></i><p>Clientes</p></a>
      @endif
    @endif
