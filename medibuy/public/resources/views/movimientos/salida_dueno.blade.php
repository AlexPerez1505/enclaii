...
<div class="mv-shell">
  <form action="{{ route('movimientos.guardar', $id) }}" method="POST" enctype="multipart/form-data" class="mv-form">
    @csrf
    ...
    <div class="mv-layout" style="margin-top:90px;">
        ...
        <div class="mv-card">
          <div class="mv-header">
            <div class="mv-header-top">
              <span class="mv-tag">Movimiento · Entrega</span>
              <span class="mv-equipo-id">Equipo ID: <strong>{{ $id }}</strong></span>
            </div>
            <h2 class="mv-title">Checklist de entrega</h2>
            <p class="mv-subtitle">
              Marca los puntos que se verificaron antes de entregar el equipo al dueño.
            </p>
          </div>

          <div class="mv-section">
            <div class="defecto-container">
              <label class="checkbox-card" for="check-entrega-1">
                <input type="checkbox" id="check-entrega-1" name="checklist[]" value="Equipo limpio">
                <span>Equipo limpio</span>
              </label>

              <label class="checkbox-card" for="check-entrega-2">
                <input type="checkbox" id="check-entrega-2" name="checklist[]" value="Pruebas funcionales exitosas">
                <span>Pruebas funcionales exitosas</span>
              </label>

              <label class="checkbox-card" for="check-entrega-3">
                <input type="checkbox" id="check-entrega-3" name="checklist[]" value="Accesorios completos y revisados">
                <span>Accesorios completos y revisados</span>
              </label>

              <label class="checkbox-card" for="check-entrega-4">
                <input type="checkbox" id="check-entrega-4" name="checklist[]" value="Validación de número de serie">
                <span>Validación de número de serie</span>
              </label>

              <label class="checkbox-card" for="check-entrega-5">
                <input type="checkbox" id="check-entrega-5" name="checklist[]" value="Confirmación de funcionamiento de botones">
                <span>Confirmación de funcionamiento de botones</span>
              </label>

              <label class="checkbox-card" for="check-entrega-6">
                <input type="checkbox" id="check-entrega-6" name="checklist[]" value="Inspección visual final">
                <span>Inspección visual final</span>
              </label>

              <label class="checkbox-card" for="check-entrega-7">
                <input type="checkbox" id="check-entrega-7" name="checklist[]" value="Embalaje correcto">
                <span>Embalaje correcto</span>
              </label>

              <label class="checkbox-card" for="check-entrega-8">
                <input type="checkbox" id="check-entrega-8" name="checklist[]" value="Verificación de conectores y cables">
                <span>Verificación de conectores y cables</span>
              </label>
            </div>
          </div>
        </div>
      ...
      {{-- 🔹 CONTENEDOR DERECHO: OBSERVACIONES + EVIDENCIAS + VIDEO + BOTONES --}}
      <div class="mv-col-right">
        <div class="mv-card">
          {{-- Observaciones --}}
          <div class="mv-section">
            <label for="descripcion" class="label_nomina">Observaciones / notas finales</label>
            <textarea
              id="descripcion"
              class="form-control mv-textarea"
              name="descripcion"
              placeholder="Condición final del equipo, notas adicionales, comentarios del usuario, etc."
              required
            ></textarea>
          </div>
          ...
          <div class="mv-actions">
            ...
            <button type="submit" class="btn btn-primary btn-custom">
              <img src="/images/like.png" alt="Icono Guardar">
              Guardar
            </button>
          </div>
        </div>
