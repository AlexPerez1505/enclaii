...
<style>
  ...
  /* Contenedor maestro (ancho reducido) */
  .content-wrap,
  .hero{
  ...
  /* Chips mini para watchers (acceso) */
...
{{-- ===== HERO ===== --}}
<div class="hero blur-on-sheet fade-slide d-flex align-items-center justify-content-between flex-wrap" style="margin-top:100px;">
...
<div class="content-wrap blur-on-sheet">
  ...
  <div class="block mt-2">
      ...
      <table class="table table-hover align-middle mb-0" id="ticketsTable">
        ...
        @forelse($tickets as $t)
          <tr>
            ...
            {{-- Visibilidad segun DB: private / shared / public --}}
            ...
            {{-- ===== Asignado + Watchers en chips, sin guion si hay watchers ===== --}}
            <td class="text-muted" data-th="Asignado / Acceso">
              ...
              {{-- Asignado (si hay) o guion provisional --}}
              @if($assigneeName)
    ...
    {{-- Paginación centrada (se oculta cuando hay filtro activo) --}}
...
<script>
/* ===== Bottom Sheet + Buscador funcional ===== */
(function(){
  ...
  if (window.visualViewport) {
    const updateKB = () => { const gap = Math.max(0, (window.innerHeight - visualViewport.height)); document.documentElement.style.setProperty('--kb', gap ? gap + 'px' : '0px'); };
