...
<head>
    ...
    <!-- Bootstrap / DataTables / estilos existentes -->
    ...
    <style>
        ...
        /* 🎨 Todo lo que sigue va encapsulado con prefijo .cotz-  */
        .cotz-root{
            --cotz-border:#dde2f3;
            --cotz-primary:#4f7dff;
        ...
        /* ✅ Dropdown NOTIFICACIONES (minimalista y moderno + TIPOGRAFÍA NORMAL) */
        .cotz-notif-menu{
            font-family:"Quicksand", system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;
            width:360px;
            max-width:92vw;
...
@php
    ...
    // FOTO DESDE users.imagen (si existe)
    $avatarSrc = null;
    if ($u && !empty($u->imagen)) {
        $raw = $u->imagen;
        if (is_string($raw)) {
        ...
        <nav class="cotz-nav">
            <ul class="cotz-nav__section">
                ...
                @if(Auth::user()->hasRole('admin') || Auth::user()->hasRole('editor'))
                    ...
                    <li>
                        <details class="cotz-nav__group">
                            <summary>
                                <svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" fill="none" stroke-width="1.7">
                                    <path d="M4 19h16"/>
                                    <rect x="6" y="10" width="2.5" height="6" rx="1"/>
                                    <rect x="11" y="7" width="2.5" height="9" rx="1"/>
                                    <rect x="16" y="5" width="2.5" height="11" rx="1"/>
                                </svg>
                            ...
                            <div class="cotz-nav__submenu">
                                <a href="{{ url('/propuestas') }}" class="cotz-nav__sublink"><span>Cotización</span></a>
                                <a href="{{ url('/clientes/vista') }}" class="cotz-nav__sublink"><span>Clientes</span></a>
                            </div>
                        </details>
                    </li>
                    ...
                    <!-- Remisiones -->
                    <li>
                        <a href="{{ url('/ventas') }}" class="cotz-nav__link">
                            <svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" fill="none" stroke-width="1.7">
                    ...
                    <!-- Remisiones -->
                    <li>
                        <a href="{{ url('/remisions') }}" class="cotz-nav__link">
                            <svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" fill="none" stroke-width="1.7">
                                    <circle cx="9" cy="9" r="3"/>
                                    <path d="M9 3v2M9 13v2M3 9h2M13 9h2M5.5 5.5l1.4 1.4M11.1 11.1l1.4 1.4M5.5 12.5l1.4-1.4"/>
                                    <path d="M15 15l3 3 2-2-3-3z"/>
                            </svg>
                    ...
                    <!-- Financiamientos -->
                    <li>
                        <a href="{{ url('/ventas/deudores') }}" class="cotz-nav__link">
                            <svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" fill="none" stroke-width="1.7">
                    ...
                    <!-- Ordenes -->
                    <li>
                        <a href="{{ url('/ordenes') }}" class="cotz-nav__link">
                            <svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" fill="none" stroke-width="1.7">
                                <rect x="5" y="3" width="14" height="18" rx="2"/>
                                <path d="M9 8h7M9 12h7M9 16h5"/>
                                <path d="M7 8l-2 2M7 12l-2 2M7 16l-2 2"/>
                            </svg>
                            <span>Ordenes</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <details class="cotz-nav__group">
                            ...
                            <div class="cotz-nav__submenu">
                                ...
                                <a href="{{ url('/asistencias/historial') }}" class="cotz-nav__sublink">
    ...
    <div class="cotz-shell" id="cotzShell">
        <header class="cotz-topbar">
            ...
            <div class="cotz-topbar__right">
                {{-- 🔔 Dropdown de notificaciones (MODERNO + TIEMPO REAL) --}}
                <div class="dropdown">
                    <button
                        type="button"
        ...
        {{-- ✅ AQUÍ SOPORTAMOS SECTION Y SLOT SIN ROMPER NADA --}}
        @hasSection('content')
            @yield('content')
        @else
            {{ $slot ?? '' }}
...
<script>
/**
 * 🔔 NOTIFICACIONES (AJAX en tiempo real) — estable (no se quita), sin recargar
 * - Click: marcar leída + navegar
 * - Marcar todas: sin recargar
 * - Polling cada 3s
 * - Si poll devuelve HTML/419/etc NO borra UI
 */
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Marcar todas leídas sin recargar
    if (readAllForm) {
